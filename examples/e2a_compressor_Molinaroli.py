...
def main():
    ...
    help(Molinaroli_2017_Compressor)
    ...
    p_outlet = 6e5
    print(f"{compressor.state_outlet=}")  # still None
    ...
    for ratio in ratios:
        ...
        T_outlets.append(compressor.state_outlet.T)
    ...
    for speed in speeds:
        m_flows.append(compressor.calc_m_flow(
