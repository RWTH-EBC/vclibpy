            ...
            if T_iteration == True :
                ...
                while True:
                    ...
                    while True:
                        ...
                        print(f"m_flow_Secondary_cp: {self.economizer.m_flow_secondary_cp} ")
                        print(f"cp_secondary: {self.economizer.m_flow_secondary_cp / self.economizer.m_flow_secondary}")
