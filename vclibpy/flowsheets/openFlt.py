...
class openFlt(BaseCycle):
    ...
    def calc_states(self, p_1, p_2, inputs: Inputs, fs_state: FlowsheetState):
        ...
        while True:
            ...
            self.flashtank.state_inlet_low = self.compressor_low.state_outlet
            ...
            # state 1**
            self.compressor_high.state_inlet = self.flashtank.state_outlet_vapor

            # state 2
            self.compressor_high.calc_state_outlet(p_outlet=p_2, inputs=inputs, fs_state=fs_state)
